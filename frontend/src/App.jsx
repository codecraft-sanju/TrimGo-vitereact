...
// 2. IMPORT API HELPER (Crucial for connecting backend)
...
const AppContent = () => {
  ...
  if (authLoading) return <div className="min-h-screen flex items-center justify-center bg-zinc-50 font-sans">Loading...</div>;
    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/user/login" element={
          <UserLogin 
             onBack={() => navigate("/")}
             onLogin={handleAuthSuccess} // Connects to Auth Logic
          />
        } />
        ...
        <Route path="/register/user" element={
          <UserRegistration
            onBack={() => navigate("/")}
            onRegisterUser={handleAuthSuccess} // Connects to Auth Logic
          />
        } />
        ...
        <Route path="/dashboard/user" element={
          <UserDashboard
            user={currentUser} // Pass real user data
            onLogout={handleLogout} // Connect to Logout Logic
            salons={salons} 
        ...
        <Route path="/dashboard/user/profile" element={
          <UserProfile 
            user={currentUser || { name: "Guest" }} // Pass real user data
